...
class PeerToPeerServer:
    ...
    def start(self):
        ...
        while self.is_running:
            try:
                ...
                self.clientsThreadsList[client_socket.getpeername()] = client_thread
                print(4)
                client_thread.start()
                print(5)
    ...
    def handle_client(self, client_socket):
        ...
        try:
            while True and self.is_running:
                ...
                self.set_current_position(data)
    ...
    # Safely read currentPosition
    def get_current_position(self):
        with self.lock:
            return self.currentPosition

    # Safely set currentPosition
